public abstract class Object {
  ...
  boolean collidesWith(Object o) {
    ...
    if (shape instanceof Sphere && o.shape instanceof Sphere) {
      Sphere s1 = (Sphere) shape;
      Sphere s2 = (Sphere) o.shape;
      return dist(x, y, z, o.x, o.y, o.z) < s1.radius + s2.radius;
    }
    if (shape instanceof Sphere && o.shape instanceof Rectangle) {
    ...
    if (shape instanceof Rectangle && o.shape instanceof Sphere) {
